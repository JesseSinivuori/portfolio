  ...
  return (
    <div className="mt-12" >
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        ...
        h-44 rounded-xl lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat
        bg-cover bg-center hover:drop-shadow-xl flex-1">
          <div className="flex justify-between items-center ">
            <div>
              <p className="font-bold text-gray-400">Earnings</p>
              <p className="text-2xl drop-shadow-xl">$65,535.65</p>
            </div>
          </div>
          <div className="mt-6">
            <Button color='white'
        ...
        ">
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center ">
            <div className="border-r-1 border-color m-4 pr-10 ">
              <div>
                <p>
                  <span className="text-3xl font-semibold">$95,654</span>
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semibold">$36,756</span>
