...
const HeroGradient = () => (
  <div
    className={
      "absolute z-[0] h-[100vh] w-[80vw] animate-spin-and-pulse-20s blur-[100px] xss:h-[80vh] xss:w-[80vw]"
    }
  >
    ...
    >
      ...
      <div className={`flex  ${styles.flexCenter} relative my-10 md:my-0`}>
        <Image
          ...
          priority
        />
        <div className="absolute z-[0] h-[600px] w-[600px] rounded-full bg-cyan-800/25 opacity-10 blur-[100px]"></div>
      </div>
    </section>
  );
}
